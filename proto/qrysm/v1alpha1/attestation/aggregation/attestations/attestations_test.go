...
func TestAggregateAttestations_AggregatePair(t *testing.T) {
	...
	tests := []struct {
		a1   *qrysmpb.Attestation
		a2   *qrysmpb.Attestation
		want *qrysmpb.Attestation
		err  string
	}{

		{
			a1:   &qrysmpb.Attestation{AggregationBits: []byte{}},
			a2:   &qrysmpb.Attestation{AggregationBits: []byte{}},
			want: &qrysmpb.Attestation{AggregationBits: []byte{}},
		},
		{
			a1: &qrysmpb.Attestation{
