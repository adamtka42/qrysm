...
// Hash: 68b59d5f3ff95048ba57e0e5ade138afb24ed2e78fc86342bb3ae33553958c17
package qrl
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'CommitteeIndex'
	a.CommitteeIndex = github_com_theQRL_qrysm_consensus_types_primitives.CommitteeIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (p *ProposerSlashing) UnmarshalSSZ(buf []byte) error {
	...
	if err = p.Header_1.UnmarshalSSZ(buf[0:4739]); err != nil {
		return err
	}
	...
	if err = p.Header_2.UnmarshalSSZ(buf[4739:9478]); err != nil {
		return err
	}
...
func (s *SignedBlindedBeaconBlockZond) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(BlindedBeaconBlockZond)
	}
	offset += s.Block.SizeSSZ()
...
// MarshalSSZ ssz marshals the BuilderBidZond object
func (b *BuilderBidZond) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BuilderBidZond object to a target array
func (b *BuilderBidZond) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(2628)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Header == nil {
		b.Header = new(v1.ExecutionPayloadHeaderZond)
	}
	...
	// Field (2) 'Pubkey'
	if size := len(b.Pubkey); size != 2592 {
		err = ssz.ErrBytesLengthFn("--.Pubkey", size, 2592)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BuilderBidZond object
func (b *BuilderBidZond) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 2628 {
		return ssz.ErrSize
	...
	// Field (2) 'Pubkey'
	if cap(b.Pubkey) == 0 {
		b.Pubkey = make([]byte, 0, len(buf[36:2628]))
	}
	b.Pubkey = append(b.Pubkey, buf[36:2628]...)
...
// SizeSSZ returns the ssz encoded size in bytes for the BuilderBidZond object
func (b *BuilderBidZond) SizeSSZ() (size int) {
	size = 2628
...
// HashTreeRoot ssz hashes the BuilderBidZond object
func (b *BuilderBidZond) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BuilderBidZond object with a hasher
func (b *BuilderBidZond) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (d *Deposit_Data) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(d.PublicKey); size != 2592 {
		err = ssz.ErrBytesLengthFn("--.PublicKey", size, 2592)
		return
	}
...
func (d *Deposit_Data) UnmarshalSSZ(buf []byte) error {
	...
	if cap(d.PublicKey) == 0 {
		d.PublicKey = make([]byte, 0, len(buf[0:2592]))
	}
	d.PublicKey = append(d.PublicKey, buf[0:2592]...)
...
func (f *Fork) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Epoch'
	f.Epoch = github_com_theQRL_qrysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (h *HistoricalBatch) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'BlockRoots'
	if size := len(h.BlockRoots); size != 1024 {
		err = ssz.ErrVectorLengthFn("--.BlockRoots", size, 1024)
		return
	}
	for ii := 0; ii < 1024; ii++ {
	...
	// Field (1) 'StateRoots'
	if size := len(h.StateRoots); size != 1024 {
		err = ssz.ErrVectorLengthFn("--.StateRoots", size, 1024)
		return
	}
	for ii := 0; ii < 1024; ii++ {
...
func (h *HistoricalBatch) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'BlockRoots'
	h.BlockRoots = make([][]byte, 1024)
	for ii := 0; ii < 1024; ii++ {
		if cap(h.BlockRoots[ii]) == 0 {
			h.BlockRoots[ii] = make([]byte, 0, len(buf[0:32768][ii*32:(ii+1)*32]))
		}
		h.BlockRoots[ii] = append(h.BlockRoots[ii], buf[0:32768][ii*32:(ii+1)*32]...)
	}

	// Field (1) 'StateRoots'
	h.StateRoots = make([][]byte, 1024)
	for ii := 0; ii < 1024; ii++ {
		if cap(h.StateRoots[ii]) == 0 {
			h.StateRoots[ii] = make([]byte, 0, len(buf[32768:65536][ii*32:(ii+1)*32]))
		}
		h.StateRoots[ii] = append(h.StateRoots[ii], buf[32768:65536][ii*32:(ii+1)*32]...)
	}
...
func (s *SyncAggregatorSelectionData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	s.Slot = github_com_theQRL_qrysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
// MarshalSSZ ssz marshals the BeaconStateZond object
func (b *BeaconStateZond) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconStateZond object to a target array
func (b *BeaconStateZond) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(2834861)
	...
	if size := len(b.Slashings); size != 1024 {
		err = ssz.ErrVectorLengthFn("--.Slashings", size, 1024)
		return
	}
	for ii := 0; ii < 1024; ii++ {
	...
	if b.LatestExecutionPayloadHeader == nil {
		b.LatestExecutionPayloadHeader = new(v1.ExecutionPayloadHeaderZond)
	}
	...
	if size := len(b.ExecutionDataVotes); size > 2048 {
		err = ssz.ErrListTooBigFn("--.ExecutionDataVotes", size, 2048)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BeaconStateZond object
func (b *BeaconStateZond) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 2834861 {
		return ssz.ErrSize
	...
	// Field (2) 'Slot'
	b.Slot = github_com_theQRL_qrysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[40:48]))
	...
	// Field (5) 'BlockRoots'
	b.BlockRoots = make([][]byte, 1024)
	for ii := 0; ii < 1024; ii++ {
		if cap(b.BlockRoots[ii]) == 0 {
			b.BlockRoots[ii] = make([]byte, 0, len(buf[176:32944][ii*32:(ii+1)*32]))
		}
		b.BlockRoots[ii] = append(b.BlockRoots[ii], buf[176:32944][ii*32:(ii+1)*32]...)
	}

	// Field (6) 'StateRoots'
	b.StateRoots = make([][]byte, 1024)
	for ii := 0; ii < 1024; ii++ {
		if cap(b.StateRoots[ii]) == 0 {
			b.StateRoots[ii] = make([]byte, 0, len(buf[32944:65712][ii*32:(ii+1)*32]))
		}
		b.StateRoots[ii] = append(b.StateRoots[ii], buf[32944:65712][ii*32:(ii+1)*32]...)
	}
	...
	for ii := 0; ii < 65536; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[65808:2162960][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[65808:2162960][ii*32:(ii+1)*32]...)
	}

	// Field (14) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 1024)
	for ii := 0; ii < 1024; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[2162960:2171152][ii*8 : (ii+1)*8])
	}
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2171285:2503061]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2503061:2834837]); err != nil {
		return err
	}

	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[2834837:2834841]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2834841:2834849])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2834849:2834857]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[2834857:2834861]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
	...
	{
		buf = tail[o11:o12]
		num, err := ssz.DivideInt2(len(buf), 2713, 1099511627776)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Validators[ii].UnmarshalSSZ(buf[ii*2713 : (ii+1)*2713]); err != nil {
				return err
			}
		}
	}
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconStateZond object
func (b *BeaconStateZond) SizeSSZ() (size int) {
	size = 2834861
...
// HashTreeRoot ssz hashes the BeaconStateZond object
func (b *BeaconStateZond) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconStateZond object with a hasher
func (b *BeaconStateZond) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (s *Status) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'FinalizedEpoch'
	s.FinalizedEpoch = github_com_theQRL_qrysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[36:44]))
	...
	// Field (4) 'HeadSlot'
	s.HeadSlot = github_com_theQRL_qrysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[76:84]))
...
func (b *BeaconBlocksByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	b.StartSlot = github_com_theQRL_qrysm_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (q *QNRForkID) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(q)
}

// MarshalSSZTo ssz marshals the QNRForkID object to a target array
func (q *QNRForkID) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'CurrentForkDigest'
	if size := len(q.CurrentForkDigest); size != 4 {
		err = ssz.ErrBytesLengthFn("--.CurrentForkDigest", size, 4)
		return
	}
	dst = append(dst, q.CurrentForkDigest...)

	// Field (1) 'NextForkVersion'
	if size := len(q.NextForkVersion); size != 4 {
		err = ssz.ErrBytesLengthFn("--.NextForkVersion", size, 4)
		return
	}
	dst = append(dst, q.NextForkVersion...)

	// Field (2) 'NextForkEpoch'
	dst = ssz.MarshalUint64(dst, uint64(q.NextForkEpoch))

	return
}

// UnmarshalSSZ ssz unmarshals the QNRForkID object
func (q *QNRForkID) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 16 {
		return ssz.ErrSize
	...
	// Field (0) 'CurrentForkDigest'
	if cap(q.CurrentForkDigest) == 0 {
		q.CurrentForkDigest = make([]byte, 0, len(buf[0:4]))
	}
	q.CurrentForkDigest = append(q.CurrentForkDigest, buf[0:4]...)

	// Field (1) 'NextForkVersion'
	if cap(q.NextForkVersion) == 0 {
		q.NextForkVersion = make([]byte, 0, len(buf[4:8]))
	}
	q.NextForkVersion = append(q.NextForkVersion, buf[4:8]...)

	// Field (2) 'NextForkEpoch'
	q.NextForkEpoch = github_com_theQRL_qrysm_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the QNRForkID object
func (q *QNRForkID) SizeSSZ() (size int) {
	size = 16
	return
}

// HashTreeRoot ssz hashes the QNRForkID object
func (q *QNRForkID) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(q)
}

// HashTreeRootWith ssz hashes the QNRForkID object with a hasher
func (q *QNRForkID) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	hh.PutBytes(q.CurrentForkDigest)
	...
	hh.PutBytes(q.NextForkVersion)

	// Field (2) 'NextForkEpoch'
	hh.PutUint64(uint64(q.NextForkEpoch))
...
func (s *SyncCommitteeMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ValidatorIndex'
	s.ValidatorIndex = github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[40:48]))

	// Field (3) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[48:4675]))
	}
	s.Signature = append(s.Signature, buf[48:4675]...)
...
func (s *SyncCommitteeContribution) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	for ii := 0; ii < len(s.Signatures); ii++ {
		if size := len(s.Signatures[ii]); size != 4627 {
			err = ssz.ErrBytesLengthFn("--.Signatures[ii]", size, 4627)
			return
		}
...
func (s *SyncCommitteeContribution) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'Signatures'
	{
		...
		for ii := 0; ii < num; ii++ {
			if cap(s.Signatures[ii]) == 0 {
				s.Signatures[ii] = make([]byte, 0, len(buf[ii*4627:(ii+1)*4627]))
			}
			s.Signatures[ii] = append(s.Signatures[ii], buf[ii*4627:(ii+1)*4627]...)
		}
	}
	return err
}
...
func (c *ContributionAndProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'SelectionProof'
	if size := len(c.SelectionProof); size != 4627 {
		err = ssz.ErrBytesLengthFn("--.SelectionProof", size, 4627)
		return
	}
...
func (c *ContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	c.AggregatorIndex = github_com_theQRL_qrysm_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
	...
	if cap(c.SelectionProof) == 0 {
		c.SelectionProof = make([]byte, 0, len(buf[12:4639]))
	}
	c.SelectionProof = append(c.SelectionProof, buf[12:4639]...)
...
func (v *Validator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'PublicKey'
	if size := len(v.PublicKey); size != 2592 {
		err = ssz.ErrBytesLengthFn("--.PublicKey", size, 2592)
		return
	}
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	if cap(v.PublicKey) == 0 {
		v.PublicKey = make([]byte, 0, len(buf[0:2592]))
	}
	v.PublicKey = append(v.PublicKey, buf[0:2592]...)
