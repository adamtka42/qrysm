...
func TestPrepareBeaconProposer(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "Happy Path",
			request: []*shared.FeeRecipient{{
				FeeRecipient:   "Q00000000000000000000000000000000000000000000000000000000b698D697092822185bF0311052215d5B5e1F3934",
				ValidatorIndex: "1",
			},
			},
			code:    http.StatusOK,
...
`
	...
	invalidBeaconCommitteeContribution = `[
  {
	...
	registrations = `[{
    "message": {
      "fee_recipient": "Q00000000000000000000000000000000000000000000000000000000abcf8e0d4e9587369b2301d0790347320302cc09",
      "gas_limit": "1",
      "timestamp": "1",
