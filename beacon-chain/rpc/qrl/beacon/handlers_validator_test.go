...
func TestGetValidators(t *testing.T) {
	...
	t.Run("get all", func(t *testing.T) {
		...
		assert.Equal(t, "0x000000000000000000000000000000002410fc4956469e6ed26c3064e46f3dca335970754fa2075f20ef21d3eb32bfe9762ba2d6da224785f69ff044f780e663", val.Validator.WithdrawalCredentials)
...
func TestGetValidator(t *testing.T) {
	...
	t.Run("get by index", func(t *testing.T) {
		...
		assert.Equal(t, "0x0000000000000000000000000000000041c439dc83e5d4376b3122fd2ca386fb88c1327d2df86c993ccdad08bef3d4c364e1cc13cfefdfc50efe6d637e91f42a", resp.Data.Validator.WithdrawalCredentials)
