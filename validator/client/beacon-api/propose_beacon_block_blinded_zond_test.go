			...
			Block: &qrysmpb.BlindedBeaconBlockZond{
				...
				Body: &qrysmpb.BlindedBeaconBlockBodyZond{
					...
					Deposits: []*qrysmpb.Deposit{
						{
							...
							Data: &qrysmpb.Deposit_Data{
								...
								WithdrawalCredentials: test_helpers.FillByteSlice(80, 95),
								Amount:                96,
						...
						},
						{
							...
							Data: &qrysmpb.Deposit_Data{
								...
								WithdrawalCredentials: test_helpers.FillByteSlice(80, 101),
								Amount:                102,
					...
					ExecutionPayloadHeader: &enginev1.ExecutionPayloadHeaderZond{
						...
						FeeRecipient:     test_helpers.FillByteSlice(48, 113),
